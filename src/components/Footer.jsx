    ...
    <footer className="border-t border-border bg-surface-base">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-6 py-8 sm:flex-row sm:justify-between">
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <span className="text-sm font-medium text-tactical-200">
            {CONFIG.businessName}
          </span>
          <span className="text-xs text-tactical-400">
            Equipamiento táctico y seguridad
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="flex items-center gap-2 text-sm text-tactical-300 transition-colors duration-200 hover:text-accent-light no-underline"
          >
